...
function ArticleByID() {
  ...
  useEffect(() => {
    ...
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(`https://week-9-10-kn3e.onrender.com/user-api/article/${id}`, { withCredentials: true });
  ...
  const toggleArticleStatus = async () => {
    ...
    try {
      ...
      `https://week-9-10-kn3e.onrender.com/author-api/articles/${id}/status`,
  ...
  const addComment = async (commentObj) => {
    ...
    let res = await axios.put("https://week-9-10-kn3e.onrender.com/user-api/articles", commentObj, { withCredentials: true });
    if (res.status === 200) {
      toast.success(res.data.message);
      setArticle(res.data.payload);
    }
